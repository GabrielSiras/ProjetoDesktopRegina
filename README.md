...
O projeto segue uma estrutura modular para facilitar o desenvolvimento em grupo:

/assets: Arquivos de arte e áudio originais.

/scenes: Cenas da Godot (Player, Inimigos, Fases).
